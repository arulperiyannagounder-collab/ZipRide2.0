...
export default function RideTrackerView({
  ...
  const transitionTo = (nextState: RideState) => {
    ...
    if (nextState === 'payment_pending' || nextState === 'payment_processing') {
  ...
  return (
    <div className="space-y-6">
      ...
      {showPaymentModal && (rideState === 'payment_pending' || rideState === 'payment_processing') && (activeRide || completedRide) && (
